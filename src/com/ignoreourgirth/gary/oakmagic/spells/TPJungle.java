...
public class TPJungle extends Spell{

	Location tpDestination;
	
	public TPJungle(int id) {
		super(id);
		tpDestination = new Location(OakMagic.server.getWorld("new_world"), -9233.73917, 68, 8459.58477);
	}
	...
	public void execute(Player caster, Entity targetEntity, Location targetLocation, int spellLevel) {
		...
		caster.sendMessage("§2You have teleported to the jungle.");
