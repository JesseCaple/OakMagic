...
public class TPDesert extends Spell{

	Location tpDestination;
	
	public TPDesert(int id) {
		super(id);
		tpDestination = new Location(OakMagic.server.getWorld("new_world"), 5572.32769, 67.62, 4319.61939);
	}
	...
	public void execute(Player caster, Entity targetEntity, Location targetLocation, int spellLevel) {
		...
		caster.sendMessage("§2You have teleported to the desert.");
