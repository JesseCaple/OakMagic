...
public class TPTiaga extends Spell{

	Location tpDestination;
	
	public TPTiaga(int id) {
		super(id);
		tpDestination = new Location(OakMagic.server.getWorld("new_world"), 2824.14545, 68.62, -877.441936);
	}
	...
	public void execute(Player caster, Entity targetEntity, Location targetLocation, int spellLevel) {
		...
		caster.sendMessage("§2You have teleported to the tiaga.");
